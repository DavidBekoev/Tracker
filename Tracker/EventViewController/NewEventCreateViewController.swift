//
//  NewEventCreateViewController.swift
//  Tracker
//
...
final class NewEventCreateViewController: UIViewController, ConfigurableView, CategorySelectionDelegate {
    ...
    weak var delegate: NewEventCreateViewControllerDelegate?
    ...
    private func updateCreateButtonState() {
        ...
        createButton.setTitleColor(isFormComplete ? .white : .white, for: .normal)
    }
...
extension NewEventCreateViewController: UITableViewDelegate, UITableViewDataSource {
...
extension NewEventCreateViewController: UITextFieldDelegate {
...
extension NewEventCreateViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
